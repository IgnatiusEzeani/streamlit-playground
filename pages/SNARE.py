...
# header and footer style
  """<style>
  .header{background-color: #d5dade; left: 0; width: 100%; margin-top:-80px; ;font-size:1.25vw; position: fixed; overflow: hidden;}
...
<table class="header">
  <tr>
    ...
    <td style="text-align: center; width:10%; font-size:1vw"><a href="#ADVANCED">Advanced</a></td>
    <td style="text-align: center; width:10%; font-size:1vw"><a href="#ABOUT">About</a></td>
  </tr>
</table>

<h3 style='text-align: center; color: #0c0d0c;'>1. Load your corpus</h> 
...
if button=='Paste your corpus':
    text_data = st.text_area('Load your data:', placeholder='Copy and paste your data from other applications or websites. You can use tabular (TSV, CSV, DSV) or JSON data.', height=150)
    sac.buttons([
